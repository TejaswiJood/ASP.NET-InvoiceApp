    ...
    public class InvoicingDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<PaymentTerms>()
                .HasData(new PaymentTerms() { PaymentTermsId = 1, Description = "Net due 10 days", DueDays = 10 },
            ...
            modelBuilder.Entity<Invoice>()
                .HasData(new Invoice() { InvoiceId = 1, InvoiceDate = new DateTime(2022, 8, 5), PaymentTermsId = 3, CustomerId = 1 },
            ...
            modelBuilder.Entity<InvoiceLineItem>()
                .HasData(new InvoiceLineItem() { InvoiceLineItemId = 1, Description = "Part 123", Amount = 1089.99, InvoiceId = 1 },
